...
public class Artikl implements Serializable {
	...
	@Id
	@GeneratedValue (strategy = GenerationType.SEQUENCE, generator="artikl_generator")
	@SequenceGenerator(name = "artikl_generator", sequenceName = "artikl_seq", allocationSize=1)
	private Integer id;
